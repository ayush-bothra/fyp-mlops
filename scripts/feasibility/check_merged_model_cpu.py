...
and measure peak RAM for the load step and the inference step SEPARATELY
-- these are different numbers and either one could be the actual
bottleneck against the ~2GB Pi 5 target.

Usage:
    python scripts/feasibility/check_merged_model_cpu.py --model-path results/f2/merged_model
"""
